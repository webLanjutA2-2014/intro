...
<head>
 ...
 <form action=" " method="POST" enctype="multipart/form-data">
    	...
    	<tr>
        	...
        	<td align="left"><input type="text" name="waktu_penitipan"></td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td><a href="lihat.php">Kembali ke Menu</a></td>
    	</tr>
  		</table>
		</form>
 <?php
	...
	$no  = $_POST['no_hp'];
	$lo  = $_POST['no_loker'];
	$lok  = $_POST['waktu_penitipan'];
	
	$sql="insert into nitip(id,nama_pengguna,deskripsi,no_hp,no_loker,waktu_penitipan)values
