...
<?php
	...
	$sql="Update nitip set waktu_pengambilan=now() ,
	 selisih=(select timestampdiff(Hour,waktu_penitipan, waktu_pengambilan)), status=(selisih*1000) where id='$cari'";
...
?>
	...
	while ($data =mysqli_fetch_assoc($query)){
		...
		echo "<td>".$data['waktu_pengambilan']."</td>";
